...
int MPC_generateBeaverTripleShares(Params *params, ShamirShare **a, ShamirShare **b, ShamirShare **c) {
    ...
    /* Share a,b,c */
    CHECK_C (Shamir_CreateShares(HSM_THRESHOLD_SIZE, HSM_GROUP_SIZE, a_raw, params->order, a);
    CHECK_C (Shamir_CreateShares(HSM_THRESHOLD_SIZE, HSM_GROUP_SIZE, b_raw, params->order, b);
    CHECK_C (Shamir_CreateShares(HSM_THRESHOLD_SIZE, HSM_GROUP_SIZE, c_raw, params->order, c);
